...
func run() error {
	...
	), theHandler.HandleQuery)

	theServer.AddTool(mcp.NewTool("mutate",
	...
	), theHandler.HandleMutateBatch)

	theServer.AddTool(mcp.NewTool("dry_run",
	...
	), theHandler.HandleExplain)

	theServer.AddTool(mcp.NewTool("explain_analyze",
