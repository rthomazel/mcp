...
func TestSqlClassify(t *testing.T) {
	tests := []struct {
		...
		{name: "DELETE", sql: "DELETE FROM foo", allowMutate: true, wantAllowlist: dmlAllowlist, wantFlagAllowed: true, wantFlagName: "POSTGRES_MCP_ALLOW_MUTATE"},
		{name: "TRUNCATE", sql: "TRUNCATE foo", allowMutate: true, wantAllowlist: dmlAllowlist, wantFlagAllowed: true, wantFlagName: "POSTGRES_MCP_ALLOW_MUTATE"},
		{name: "CREATE", sql: "CREATE TABLE foo ()", allowMutateSchema: true, wantAllowlist: ddlAllowlist, wantFlagAllowed: true, wantFlagName: "POSTGRES_MCP_ALLOW_MUTATE_SCHEMA"},
		{name: "ALTER", sql: "ALTER TABLE foo ADD COLUMN x int", allowMutateSchema: true, wantAllowlist: ddlAllowlist, wantFlagAllowed: true, wantFlagName: "POSTGRES_MCP_ALLOW_MUTATE_SCHEMA"},
		{name: "DROP", sql: "DROP TABLE foo", allowMutateSchema: true, wantAllowlist: ddlAllowlist, wantFlagAllowed: true, wantFlagName: "POSTGRES_MCP_ALLOW_MUTATE_SCHEMA"},
		{name: "GRANT", sql: "GRANT SELECT ON foo TO user1", allowMutatePermissions: true, wantAllowlist: dclAllowlist, wantFlagAllowed: true, wantFlagName: "POSTGRES_MCP_ALLOW_MUTATE_PERMISSIONS"},
		{name: "REVOKE", sql: "REVOKE SELECT ON foo FROM user1", allowMutatePermissions: true, wantAllowlist: dclAllowlist, wantFlagAllowed: true, wantFlagName: "POSTGRES_MCP_ALLOW_MUTATE_PERMISSIONS"},
		...
		{name: "lowercase insert", sql: "insert into foo values (1)", allowMutate: true, wantAllowlist: dmlAllowlist, wantFlagAllowed: true, wantFlagName: "POSTGRES_MCP_ALLOW_MUTATE"},
		{name: "DML flag off", sql: "INSERT INTO foo VALUES (1)", allowMutate: false, wantAllowlist: dmlAllowlist, wantFlagAllowed: false, wantFlagName: "POSTGRES_MCP_ALLOW_MUTATE"},
